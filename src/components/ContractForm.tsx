                  ...
                  <div className="max-h-48 overflow-y-auto border rounded-lg">
                    {filteredCompanies.length > 0 ? (
                      ...
                      <div className="p-3 text-gray-500 text-center">
                        N
Vou continuar a remodelação do sistema para ser 100% responsivo. Vou criar os componentes restantes com foco em mobile:

<dyad-write path="src/components/ContractDetails.tsx" description="Remodelar ContractDetails para responsivo mobile com layout adaptável">
          ...
          <CardContent className="p-4">
            <div className="flex items-center">
              ...
              <div>
                ...
                <p className={`text-lg md:text-2xl font-bold ${currentContract.remainingBalance <= 0 ? 'text-red-600' : 'text-green-600'}`}>
